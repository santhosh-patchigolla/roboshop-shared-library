def sonarChecks(){
    sh '''
        ...
        sonar-scanner -Dsonar.sources=. -Dsonar.java.binaries=target/ -Dsonar.login=0d48104d8af75f393eec3c505f8f0cb743363849 -Dsonar.host.url=http://172.31.89.102:9000  -Dsonar.projectKey=${COMPONENT}
